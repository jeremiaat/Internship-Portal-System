...
const CompanyApplicationReview = () => {
  ...
  const isPdfResume = application?.resume?.toLowerCase().endsWith('.pdf');
              ...
              <div className="mt-6 pt-6 border-t">
                ...
                {isPdfResume ? (
                  <div className="mt-4 bg-gray-50 border border-gray-200 rounded-lg p-2">
                    <p className="text-xs text-gray-500 mb-2">Resume Preview</p>
                    <iframe
                  ...
                  <p className="mt-4 text-sm text-gray-500">
                    Resume preview is unavailable for this file type. Use the open button to view it in a new tab.
                  </p>
                )}
              </div>
            )}
